...
var styles = __importStar(require("components/blog-post-preview-list.module.css"));
      ...
      <ul className={styles.grid}>
        {props.nodes &&
            props.nodes.map(function (node) { return (<li key={node.id}>
              <blog_post_preview_1.default {...node} isInList/>
            </li>); })}
      </ul>
...
//# sourceMappingURL=blog-post-preview-list.jsx.map